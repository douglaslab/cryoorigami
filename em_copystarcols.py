...
def main():
    ...
    parser.add_argument("-copy-priors",   "--copypriors",   type=str, help="Copy offset and/or angle parameters to priors", default=None, choices=['angle','all'])
    parser.add_argument("-copy-offsets",  "--copyoffsets",  type=str, help="Copy priors to angle and distance offset parameters", default=None, choices=['angle','all'])
